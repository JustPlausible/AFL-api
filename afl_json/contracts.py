...
_ENDPOINTS = {
    ...
    "matches": _endpoint("matches", "/matches", "match", source=SourceSystem.PUBLIC, method=HttpMethod.GET,
        ...
        optional_query_parameters=("pageSize", "pageNum"), pagination=Pagination.RESPONSE_DRIVEN),
    "match_detail": _endpoint("match_detail", "/matches/{match_id}", "match", source=SourceSystem.PUBLIC,
        method=HttpMethod.GET, requires_auth=False, collection_paths=("matches",), identifier_type="match",
        required_path_parameters=("match_id",)),
