...
_ENDPOINTS = {
    ...
    "match_rosters": _endpoint("match_rosters", "/matchRosters/round/{round_provider_id}", "match_roster",
        source=SourceSystem.CFS, method=HttpMethod.GET, requires_auth=True, collection_paths=(), identifier_type="player",
        required_path_parameters=("round_provider_id",), verified=False,
        unverified_fields=("collection paths", "natural key", "emergency and late-change semantics")),
