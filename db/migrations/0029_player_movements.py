...
def migrate(conn):
 ...
 source_url TEXT NOT NULL, source_archived_at TEXT, observed_at TEXT NOT NULL,
 ...
 UNIQUE(movement_season_year,source_url,source_archived_at,source_team_name,source_player_name,source_label)
 )''')
 ...
 conn.execute('CREATE INDEX IF NOT EXISTS idx_player_movements_snapshot ON player_movement_observations(source_url,source_archived_at)')
