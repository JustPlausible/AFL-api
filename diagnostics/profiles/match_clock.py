...
and ``scheduler.match_state_capture``, unchanged from PR #175. This module
exists only to satisfy the framework's ``DiagnosticProfile`` contract so the
framework can own scheduling, enablement, and restart-safe registration
generically.
"""
