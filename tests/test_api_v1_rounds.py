...
def _seed_rounds(conn):
    ...
    values = [
        ...
        (102, "Round 1", SEASON_ID, 1, "R1", "2026-03-13T08:00:00Z", "2026-03-16T12:00:00Z",
         '[{"id":10,"providerId":"CD_T1","name":"untrusted provider name"},{"id":10}]'),
        (104, "Round 3", SEASON_ID, 3, "R3", None, None, None),
        (201, "Other season", 84, 1, "R1", None, None, "[]"),
        (105, "Malformed", SEASON_ID, 4, "R4", None, None,
